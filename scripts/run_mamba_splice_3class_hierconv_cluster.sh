...
CACHE_ROOT="${CACHE_ROOT:-/nemo/lab/ulej/home/users/wilkino/tmp/mamba_splice_3class_hierconv_cache}"
...
python scripts/train_mamba_splice_3class_hierconv.py \
  ...
  --hidden-dim 96 \
  --layers 6 \
  --layer-conv-kernels 1,3,3,5,7,9 \
  --local-conv-kernel 0 \
  --chunk-size 64 \
  --headdim 8 \
  --optimizer adamw \
  ...
  --val-batches 8 \
  --device cuda \
  --checkpoint-dir checkpoints/mamba_splice_3class_hierconv_pangolin_split_len15000_target5000_h96_l6_k1-3-3-5-7-9_pos300_adamw
