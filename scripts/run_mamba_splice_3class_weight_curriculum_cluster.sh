...
CACHE_ROOT="${CACHE_ROOT:-/nemo/lab/ulej/home/users/wilkino/tmp/mamba_splice_3class_weight_curriculum_cache}"
...
python scripts/train_mamba_splice_3class_weight_curriculum.py \
  ...
  --grad-clip 1 \
  --positive-weight 300 \
  --positive-weight-start 300 \
  --positive-weight-end 75 \
  --positive-weight-anneal-frac 0.8 \
  --positive-weight-schedule cosine \
  --none-weight 1 \
  --best-metric ap_mean \
  --soft-augment-prob 0 \
  ...
  --val-batches 8 \
  --device cuda \
  --checkpoint-dir checkpoints/mamba_splice_3class_weight_curriculum_pangolin_split_len15000_target5000_h96_l6_pos300to75_coslr_adamw
