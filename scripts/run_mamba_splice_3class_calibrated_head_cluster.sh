...
CACHE_ROOT="${CACHE_ROOT:-/nemo/lab/ulej/home/users/wilkino/tmp/mamba_splice_3class_calibrated_head_cache}"
...
python scripts/train_mamba_splice_3class_calibrated_head.py \
  ...
  --val-batches 8 \
  --device cuda \
  --checkpoint-dir checkpoints/mamba_splice_3class_calibrated_head_pangolin_split_len15000_target5000_h96_l6_headk9_d2_focal1_pos300_adamw
