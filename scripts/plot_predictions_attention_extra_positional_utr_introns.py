...
from train_dense_transition_phase_helper_attention_extra_positional_utr_introns import (
...
def main():
    parser = argparse.ArgumentParser(description="Headless prediction plotter for attention-extra-positional-utr-introns checkpoints.")
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="checkpoints/dense_transition_phase_helper_attention_utr5_200_extra_attn_positional_utr_introns_long/best.pt",
