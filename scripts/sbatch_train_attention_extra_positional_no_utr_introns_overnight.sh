...
python -u scripts/train_dense_transition_phase_helper_attention_extra_positional.py \
  --device cuda \
  --resume-checkpoint checkpoints/dense_transition_phase_helper_attention_utr5_200_extra_attn_positional/best.pt \
  --checkpoint-dir checkpoints/dense_transition_phase_helper_attention_utr5_200_extra_attn_positional_overnight \
  --steps 100000 \
