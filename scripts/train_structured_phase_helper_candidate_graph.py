...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train the Mamba + structured phase helper using candidate splice graph paths."
    )
    ...
    parser.add_argument(
        "--checkpoint-dir",
        type=Path,
        default=ROOT / "checkpoints" / "structured_phase_helper_candidate_graph",
    )
...
def main() -> None:
    ...
    print("task: structured translated phase helper with candidate splice graph")
    ...
    if args.evidence_model == "mamba":
        ...
        print("Mamba path source: candidate splice paths/weights supplied to structured layer")
        print("Mamba splice tracks: donor/acceptor evidence only; no deterministic path reconstruction")
    print(
