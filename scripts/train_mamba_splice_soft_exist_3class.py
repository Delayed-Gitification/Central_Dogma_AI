...
def train(args: argparse.Namespace) -> None:
    ...
    print("Mamba 3-class splice predictor with soft DNA + existence inputs")
    print(
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--checkpoint-dir", default="checkpoints/mamba_splice_soft_exist_3class")
