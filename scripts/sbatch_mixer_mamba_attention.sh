#!/usr/bin/env bash
#SBATCH --job-name=mixer_mamba_attn
...
python -u scripts/train_dense_transition_phase_helper_attention_extra_positional_utr_introns_local_conv_mixers.py \
  --device cuda \
  --checkpoint-dir checkpoints/curriculum_stage1_mixer_mamba_attention \
  --steps 4000 \
