...
from train_dense_transition_phase_helper_attention_extra_positional import (
...
def main():
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="checkpoints/dense_transition_phase_helper_attention_utr5_200_extra_attn_positional/best.pt",
