...
CACHE_ROOT="${CACHE_ROOT:-/nemo/lab/ulej/home/users/wilkino/tmp/mamba_splice_3class_big_cache}"
...
python scripts/train_mamba_splice_soft_exist_3class.py \
  ...
  --val-batches 8 \
  --device cuda \
  --checkpoint-dir checkpoints/mamba_splice_3class_big_pangolin_split_len15000_target5000_h160_l8_pos300_adamw
